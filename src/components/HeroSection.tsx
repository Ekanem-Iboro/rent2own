  ...
  return (
    <>
      ...
      <header className="  bg-[url('assets/images/net.png')] md:min-h-[700px] w-full min-h-[333px] lg:pb-0 pb-[1rem] mb-[3rem]">
        <div className="lg:flex block items-center  md:px-[5%] md:pr-[2%] w-full md:min-h-[700px]">
          <div className=" min-h-full pt-3 flex-[25%] mb-[2rem] headertxt">
            <div className=" md:text-start text-center ">
              <p className="text-[12px] text-primary leading-[14.4px] font-[500]">
                Trusted by over 50k users in Australia
              </p>
              <h1 className="md:text-[60px] md:leading-[72px] leading-[35px] text-[30px] text-[#191919] mb-0  font-[600]">
                If You Can
                <span className="text-secondary"> Rent It</span>, You Can
                <span className="text-secondary"> Own It</span>
              </h1>
              <div className="md:w-[80%] my-5 font-[400] md:px-0 px-[3rem]">
          ...
          <div className="flex-[70%]">
            <img src={carR} alt="" className="  w-[80%] mx-auto" />
          </div>
        </div>
      </header>
    </>
